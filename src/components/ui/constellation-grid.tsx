...
export default function ConstellationGrid({
    ...
    return (
        <div className={`relative w-full overflow-hidden select-none bg-slate-950 dark:bg-slate-950 light:bg-slate-50 ${className}`}>
            <canvas ref={canvasRef} className="absolute inset-0 block cursor-crosshair w-full h-full" />

            {overlayTitle && (
                <div className="relative z-10 flex h-full min-h-[400px] flex-col items-center justify-center text-center px-4 pointer-events-none mix-blend-difference text-white">
